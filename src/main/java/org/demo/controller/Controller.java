...
//        ObservableList<ClubClient> clubClients = new ClubClientController().populateClientTable(url);
//        table_clients.setItems(clubClients);
//
//    }
//
...
//        new ClubClientController().btnPOST(clubClient);
//        refreshTable();
//    }
//
...
//        ClubClient clubClient = new ClubClient(lastname.getText(), firstname.getText(), middlename.getText(),
//                phonenumber.getText(), email.getText());
//        new ClubClientController().btnPUT(getIdOfSelectedClient(), clubClient);
//        refreshTable();
//    }
//
//    //удаляет выделенного пользователя по id
//    public void btnDELETE(ActionEvent actionEvent) {
//        new ClubClientController().btnDELETE(getIdOfSelectedClient());
//        refreshTable();
//    }
//
//    //отметить сегодняшнее посещение выбранного клиента
//    public void btnConfirmVisit(ActionEvent actionEvent) {
//        new VisitDateController().btnConfirmVisit(getIdOfSelectedClient());
//    }
//
//    //отобразить в таблице посещений, даты посещения выбранного клиента
//    public void btnViewVisits(ActionEvent actionEvent) {
//        new VisitDateController().btnViewVisits(getIdOfSelectedClient());
//        table_attendance.setItems(new VisitDateController().btnViewVisits(getIdOfSelectedClient()));
//    }
//
...
//        MembershipCardCostController.btnCalculateMembershipCardCost(getIdOfSelectedClient());
//    }
//
//    //добавить в БД требуемое количество посещений для клиента по его id
//    //нужно для проверки расчета стоимости абонемента
//    public void btnTestButton(ActionEvent actionEvent) {
//        int days = Integer.parseInt(testField.getText());
//        String filtering = new StringBuilder("?id=").append(getIdOfSelectedClient()).append("&days=").append(days).toString();
